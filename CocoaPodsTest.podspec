...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/luxing123@qq.com/CocoaPodsTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'luxing123@qq.com' => 'luxing123@qq.com' }
  s.source           = { :git => 'https://github.com/luxing123@qq.com/CocoaPodsTest.git', :tag => s.version.to_s }
